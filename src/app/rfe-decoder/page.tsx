      ...
      <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8">
          ...
          <p className="text-secondary">
            Paste your Request for Evidence letter and get an AI-powered analysis with response
          ...
          <div className="space-y-6">
            ...
            <div className="flex items-start gap-3 p-4 rounded-lg bg-blue-500/5 border border-blue-500/20">
              ...
              <p className="text-xs text-muted">
                This analysis is generated by AI and does not constitute legal advice. RFE responses
